...
<tr v-for="(invoice_product, k) in invoice_products" :key="k">
    ...
    <td>
        ...
        <!-- /> -->
        <v-text-field type="number" min="0" step=".01" v-model="invoice_product.product_price" @change="calculateLineTotal(invoice_product)"></v-text-field>
    </td>
    <td>
        ...
        /> -->
        <v-text-field type="number" min="0" step=".01" v-model="invoice_product.product_qty" @change="calculateLineTotal(invoice_product)"></v-text-field>
    </td>
    <td>
