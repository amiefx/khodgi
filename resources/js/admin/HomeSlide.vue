    ...
    methods: {
        uploadPhotoS1(item) {
           if(this.editedItem.small_image != null) {
            ...
            axios.post('/api/home-slides/change-photoS', formData)
            .then(res => {
        ...
        uploadPhotoL1(item) {
           ...
           //     console.log(this.editedItem.large_image);
            ...
            axios.post('/api/home-slides/change-photoL', formData)
            .then(res => {
      ...
      initialize () {
          // Add a request interceptor
            ...
            axios.get('/api/home-slides')
                .then(res => this.homeslides = res.data.homeslides)
                .catch(err => {
      ...
      deleteItem (item) {
        ...
        if(decide){
            axios.delete('/api/home-slides/'+item.id)
            .then(res => {
      ...
      save () {
        if (this.editedIndex > -1) {
            axios.put('/api/home-slides/'+this.editedItem.id, this.editedItem)
             //   .then(res => Object.assign(this.homeslides[this.editedIndex], res.data.homeslide))
              //  .catch(err => console.log(err.response))
          Object.assign(this.homeslides[this.editedIndex], this.editedItem)
        } else {
            axios.post('/api/home-slides', this.editedItem)
